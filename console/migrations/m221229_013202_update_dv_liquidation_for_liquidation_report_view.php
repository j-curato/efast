...
/**
 * Class m221229_013202_update_dv_liquidation_for_liquidation_report_view
 */
class m221229_013202_update_dv_liquidation_for_liquidation_report_view extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        YIi::$app->db->createCommand("DROP VIEW IF EXISTS dv_for_liquidation_report;
    ...
    {
        echo "m221229_013202_update_dv_liquidation_for_liquidation_report_view cannot be reverted.\n";
