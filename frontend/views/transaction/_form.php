...
<div class="transaction-form" style="background-color: white;padding:20px">
    ...
    <div class="row">
        ...
        if (Yii::$app->user->can('super-user')) { ?>
            <div class="col-sm-3">
                <label for="responsibility_center_id"> Responsibility Center</label>
                <?= Select2::widget([
                    'data' => ArrayHelper::map($respons_center, 'id', 'name'),
                    'name' => 'responsibility_center_id',
                    'value' => $model->responsibility_center_id,
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <?= Html::textarea('particular', $model->particular, ['class' => 'form-control']) ?>
        </div>
    </div>
    ...
    <div class="form-group">
        <?= Html::submitButton('Save', ['class' => 'btn btn-success save', 'style' => 'width:100%;margin:3rem 0 4rem 0']); ?>
    </div>
