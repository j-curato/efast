        ...
        <table>
            <tbody>
                ...
                <tr>
                    <td colspan="3">
                        <span>Supplier:</span>
                        <span><?php echo $aoq_lowest['payee'] ?></span>
                        <br>
                        <span>Address:</span>
                        <span><?php echo $aoq_lowest['address'] ?></span>
                        <br>
                        <span>TIN:</span>
                        <span><?php echo $aoq_lowest['tin_number'] ?></span>
                    </td>
                    <td colspan="3">
                        <span>P.O No.:</span>
                ...
                <tr>
                    <td><?= $aoq_lowest['bac_code'] ?></td>
                    <td><?= strtoupper($aoq_lowest['unit_of_measure']) ?></td>
                    <td><?php
                        echo  $aoq_lowest['description'];
                        echo $aoq_lowest['specification'];


                        ?>
                    </td>
                    <td><?= $aoq_lowest['quantity'] ?></td>
                    <td class="amount"><?= $aoq_lowest['unit_cost'] ?></td>
                    <td class="amount"><?= intval($aoq_lowest['quantity']) * floatval($aoq_lowest['unit_cost']) ?></td>
                </tr>
                <tr>
