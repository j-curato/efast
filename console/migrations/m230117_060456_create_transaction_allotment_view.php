...
/**
 * Class m230117_060456_create_transaction_allotment_view
 */
class m230117_060456_create_transaction_allotment_view extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        Yii::$app->db->createCommand("DROP VIEW IF EXISTS transaction_allotment_view;
        CREATE VIEW transaction_allotment_view as 
        SELECT 
    ...
    {
        echo "m230117_060456_create_transaction_allotment_view cannot be reverted.\n";
