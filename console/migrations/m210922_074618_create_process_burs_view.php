...
/**
 * Class m210922_074618_create_process_burs_view
 */
class m210922_074618_create_process_burs_view extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        Yii::$app->db->createCommand("DROP VIEW IF EXISTS process_burs_view")->query();
    ...
    {
        echo "m210922_074618_create_process_burs_view cannot be reverted.\n";
