...
/**
 * Class m230110_071504_update_pr_allotment_view
 */
class m230110_071504_update_pr_allotment_view extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        CREATE VIEW pr_allotment_view as 
        SELECT 
        ...
        ) as total_pr_amt ON record_allotment_entries.id = total_pr_amt.fk_record_allotment_entries_id ")->execute();
    }
    ...
    {
        echo "m230110_071504_update_pr_allotment_view cannot be reverted.\n";
