...
/**
 * Class m230110_032326_update_record_allotment_view
 */
class m230110_032326_update_record_allotment_view extends Migration
{
    /**
     * {@inheritdoc}
     */
        ...
        YIi::$app->db->createCommand("DROP VIEW IF EXISTS record_allotments_view;
            ...
            LEFT JOIN major_accounts ON chart_of_accounts.major_account_id = major_accounts.id 
				...
				LEFT JOIN (
						...
						SUM(dv_aucs_entries.amount_disbursed) as total_ors
						FROM process_ors
						INNER JOIN process_ors_entries ON  process_ors.id =process_ors_entries.process_ors_id 
						INNER JOIN dv_aucs_entries ON process_ors.id = dv_aucs_entries.process_ors_id
    ...
    {
        echo "m230110_032326_update_record_allotment_view cannot be reverted.\n";
