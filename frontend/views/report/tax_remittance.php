            ...
            <tbody>
                ...
                if (!empty($dataProvider)) {
                    ...
                    foreach ($dataProvider as $data) {
                        ...
                        echo "<tr>
                    <td>{$data['dv_number']}</td>
                    <td class='amount'>" . number_format($data['total_vat'], 2) . "</td>
                    <td class='amount'>" . number_format($data['total_expanded'], 2) . "</td>
...
$script = <<< JS
    ...
    $('#filter').submit(function(e){
        ...
        $.pjax({
            ...
            type:'POST',
            url:window.location.pathname +'?r=report/tax-remittance',
