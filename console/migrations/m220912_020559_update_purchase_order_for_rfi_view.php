...
/**
 * Class m220912_020559_update_purchase_order_for_rfi_view
 */
class m220912_020559_update_purchase_order_for_rfi_view extends Migration
{
    /**
     * {@inheritdoc}
     */
...
GROUP BY request_for_inspection_items.fk_pr_purchase_order_items_aoq_item_id) as aoq_items_quantity ON pr_purchase_order_items_aoq_items.id = aoq_items_quantity.fk_pr_purchase_order_items_aoq_item_id
    ...
    {
        echo "m220912_020559_update_purchase_order_for_rfi_view cannot be reverted.\n";
