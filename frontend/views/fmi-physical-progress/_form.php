...
<div class="fmi-physical-progress-form">
    ...
    <?= $form->field($model, 'physical_target')->textInput(['type' => 'number']) ?>

    <?= $form->field($model, 'physical_accomplished')->textInput(['type' => 'number']) ?>
...
$js = <<<JS
    ...
    $(document).ready(function(){
        $("#FmiPhysicalProgress").on("beforeSubmit", function(event) {
