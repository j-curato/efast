...
/**
 * Class m220217_022816_update_advances_entries_for_liquidation_view
 */
class m220217_022816_update_advances_entries_for_liquidation_view extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $sql = <<<SQL
        DROP VIEW IF EXISTS advances_entries_for_liquidation ;
    ...
    {
        echo "m220217_022816_update_advances_entries_for_liquidation_view cannot be reverted.\n";
