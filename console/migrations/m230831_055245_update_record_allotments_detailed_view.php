...
/**
 * Class m230831_055245_update_record_allotments_detailed_view
 */
class m230831_055245_update_record_allotments_detailed_view extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        $sql = <<<SQL
            ...
            -- CREATE VIEW record_allotment_detailed as 
                ...
                -- SELECT 
                --     allotment_modification_advice_items.fk_record_allotment_entries_id,
                --     SUM( allotment_modification_advice_items.amount) as ttl
                -- FROM allotment_modification_advice_items
                -- WHERE 
                -- allotment_modification_advice_items.is_deleted = 0
                -- GROUP BY allotment_modification_advice_items.fk_record_allotment_entries_id
                -- )
                SELECT 
                ...
                COALESCE(record_allotment_entries.amount,0) -  IFNULL(consoUsedAllotments.ttlOrsAmt,0) as balAfterObligation,
                ...
                -- LEFT JOIN cte_allotmentAdjustments ON record_allotment_entries.id = cte_allotmentAdjustments.fk_record_allotment_entries_id
    ...
    {
        echo "m230831_055245_update_record_allotments_detailed_view cannot be reverted.\n";
