...
/**
 * Class m230906_003108_update_dv_for_liquidation_report_view
 */
class m230906_003108_update_dv_for_liquidation_report_view extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        $sql = <<<SQL
            ...
            CREATE VIEW dv_for_liquidation_report as 
                ...
                AND (dv_aucs.reporting_period >='2022-01' OR dv_aucs.id IN (7351,7426,7748,7869,7885,7965,8018))
                AND nature_of_transaction.`name` IN ('CA to Employees','CA to SDOs/OPEX') 
    ...
    {
        echo "m230906_003108_update_dv_for_liquidation_report_view cannot be reverted.\n";
