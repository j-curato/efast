...
class UserSearch extends User
{
    ...
    public function rules()
    {
        return [
            ...
            [['username', 'auth_key', 'password_hash', 'password_reset_token', 'email', 'verification_token', 'province', 'division'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'fk_division_program_unit' => $this->fk_division_program_unit,
        ]);
