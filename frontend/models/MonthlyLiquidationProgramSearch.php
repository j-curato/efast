...
/**
 * MonthlyLiquidationProgramSearch represents the model behind the search form of `app\models\MonthlyLiquidationProgram`.
 */
class MonthlyLiquidationProgramSearch extends MonthlyLiquidationProgram
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = MonthlyLiquidationProgram::find();
