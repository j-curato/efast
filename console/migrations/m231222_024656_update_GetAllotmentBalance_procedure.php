...
/**
 * Class m231222_024656_update_GetAllotmentBalance_procedure
 */
class m231222_024656_update_GetAllotmentBalance_procedure extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        cte_allotmentAdjustments as (
            SELECT 
                ...
                SUM( record_allotment_adjustments.amount)	 as total_adjustment
    ...
    GROUP BY record_allotment_adjustments.fk_record_allotment_entry_id)
        ...
        COALESCE(cte_allotmentAdjustments.total_adjustment,0)-
    ...
    {
        echo "m231222_024656_update_GetAllotmentBalance_procedure cannot be reverted.\n";
