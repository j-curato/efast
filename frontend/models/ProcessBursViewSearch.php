...
use app\models\ProcessBursView;

/**
 * ProcessBursViewSearch represents the model behind the search form of `app\models\ProcessBursView`.
 */
class ProcessBursViewSearch extends ProcessBursView
{
    /**
     * {@inheritdoc}
     */
