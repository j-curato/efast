...
/**
 * Class m230922_021409_create_prc_GetSofOffice_procedure
 */
class m230922_021409_create_prc_GetSofOffice_procedure extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $sql = <<<SQL
            DROP PROCEDURE IF EXISTS prc_GetSofOffice;
            CREATE PROCEDURE prc_GetSofOffice(IN fromPeriod VARCHAR(50), IN toPeriod VARCHAR(50),IN qry VARCHAR(500))
            BEGIN
                SET @finalQuery= CONCAT("WITH  consoUsedAllotments as (
                        SELECT 
                        ...
                        AND process_ors_entries.reporting_period >='",fromPeriod,"'
                        AND process_ors_entries.reporting_period <='",toPeriod,"'
                        ...
                        WHERE
                        cte_allotmentDetails.reporting_period >='",fromPeriod,"'
                        AND cte_allotmentDetails.reporting_period <='",toPeriod,"'
                        ",
                        qry,
                        " GROUP BY
                            cte_allotmentDetails.book_name,
                ...
                PREPARE final_query FROM @finalQuery;
                EXECUTE final_query;
    ...
    {
        echo "m230922_021409_create_prc_GetSofOffice_procedure cannot be reverted.\n";
