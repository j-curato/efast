...
/**
 * Class m230118_060249_update_pr_purchase_request_index_view
 */
class m230118_060249_update_pr_purchase_request_index_view extends Migration
{
    /**
     * {@inheritdoc}
     */
...
UNION
            ...
            LEFT JOIN employee_search_view as approved_by ON pr_purchase_request.approved_by_id = approved_by.employee_id
            LEFT JOIN books ON pr_purchase_request.book_id = books.id
WHERE pr_purchase_request.is_fixed_expense ")->execute();
    }
    ...
    {
        echo "m230118_060249_update_pr_purchase_request_index_view cannot be reverted.\n";
