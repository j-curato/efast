...
/**
 * Class m240122_063558_update_vw_procurement_to_iar_tracking_view
 */
class m240122_063558_update_vw_procurement_to_iar_tracking_view extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        $sql = <<<SQL
                ...
                (CASE pr_mode_of_procurement.is_bidding
                    WHEN 1 THEN pr_purchase_order.philgeps_reference_num
                    ELSE 'N/A'
                END 
                ) as philgeps_reference_num,
                (CASE pr_mode_of_procurement.is_bidding
                ...
                (CASE pr_mode_of_procurement.is_bidding
                    WHEN 1 THEN pr_purchase_order.pre_bid_conf
                    ELSE 'N/A'
                END 
                ) as pre_bid_conf,
                (CASE pr_mode_of_procurement.is_bidding
                    WHEN 1 THEN pr_purchase_order.eligibility_check
                    ELSE pr_rfq.deadline
                END 
                ) as eligibility_check,
                (CASE pr_mode_of_procurement.is_bidding
                    WHEN 1 THEN pr_purchase_order.opening_of_bids
                    ELSE pr_rfq.deadline
                END 
                ) as opening_of_bids,
                (CASE pr_mode_of_procurement.is_bidding
                    WHEN 1 THEN pr_purchase_order.bid_evaluation
                    ELSE pr_rfq.deadline
                END 
                ) as bid_evaluation,
                (CASE pr_mode_of_procurement.is_bidding
                    WHEN 1 THEN pr_purchase_order.post_qual
                    ELSE 'N/A'
                END 
                ) as post_qual,
                (CASE pr_mode_of_procurement.is_bidding
            ...
            cte_aoqToPoDetails.pre_bid_conf,
            cte_aoqToPoDetails.eligibility_check,
            cte_aoqToPoDetails.opening_of_bids,
            cte_aoqToPoDetails.bid_evaluation,
            cte_aoqToPoDetails.post_qual,
    ...
    {
        echo "m240122_063558_update_vw_procurement_to_iar_tracking_view cannot be reverted.\n";
