...
class PrPurchaseRequestController extends Controller
{
        ...
        foreach ($items as $i => $item) {
            ...
            try {
                ...
                if (!empty($item['item_id'])) {
                    ...
                    $q->id = Yii::$app->db->createCommand("SELECT UUID_SHORT() % 9223372036854775807")->queryScalar();
                }
    ...
    public function actionSearchPr($q = null, $id = null, $province = null)
    {
        ...
        if (!is_null($q)) {
            ...
            if (!Yii::$app->user->can('ro_procurement_admin')) {
                ...
                if (!Yii::$app->user->can('po_procurement_admin') && !YIi::$app->user->can('ro_procurement_admin') && !YIi::$app->user->can('select_purchase_request_division')) {
    ...
    public function actionGetPpmpItems()
    {
        if (Yii::$app->request->isPost) {
            ...
            $division_id = Yii::$app->request->post('division') ?? null;
