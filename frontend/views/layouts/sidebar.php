    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            ...
            $accountingMasterRecords =  [
                Yii::$app->user->can('view_payee') ? ['label' => 'Payor/Payee', 'icon' => 'dot-circle', 'iconStyle' => 'far', 'url' => ['payee/index'],] : null,
                Yii::$app->user->can('view_chart_of_account') ? ['label' => 'Chart of Accounts', 'icon' => 'dot-circle', 'iconStyle' => 'far', 'url' => ['chart-of-accounts/index'],] : null,
                Yii::$app->user->can('view_major_account') ? ['label' => 'Major Accounts', 'icon' => 'dot-circle', 'iconStyle' => 'far', 'url' => ['/major-accounts/index'],] : null,
                Yii::$app->user->can('view_sub_major_account') ? ['label' => 'Sub Major Accounts', 'icon' => 'dot-circle', 'iconStyle' => 'far', 'url' => ['/sub-major-accounts/index'],] : null,
                Yii::$app->user->can('view_sub_account_1') ? ['label' => 'Sub Account 1', 'icon' => 'dot-circle', 'iconStyle' => 'far', 'url' => ['/sub-accounts1/index'],] : null,
                Yii::$app->user->can('view_sub_account_2') ? ['label' => 'Sub Account 2', 'icon' => 'dot-circle', 'iconStyle' => 'far', 'url' => ['/sub-accounts2/index'],] : null,
                Yii::$app->user->can('view_books') ? ['label' => 'Books', 'icon' => 'dot-circle', 'iconStyle' => 'far', 'url' => ['/books/index'],] : null,
                Yii::$app->user->can('view_cash_flow') ? ['label' => 'CashFlow', 'icon' => 'dot-circle', 'iconStyle' => 'far', 'url' => ['/cash-flow/index'],] : null,
                Yii::$app->user->can('view_nature_of_transaction') ? ['label' => 'Nature of Transaction', 'icon' => 'dot-circle', 'iconStyle' => 'far', 'url' => ['/nature-of-transaction/index'],] : null,
                Yii::$app->user->can('view_mrd_classification') ? ['label' => 'MRD Classification', 'icon' => 'dot-circle', 'iconStyle' => 'far', 'url' => ['/mrd-classification/index'],] : null,
                Yii::$app->user->can('view_fund_source_type') ? ['label' => 'Fund Source Type', 'icon' => 'dot-circle', 'iconStyle' => 'far', 'url' => ['/fund-source-type/index'],] : null,
                Yii::$app->user->can('view_report_type') ? ['label' => 'Report Type', 'icon' => 'dot-circle', 'iconStyle' => 'far', 'url' => ['/report-type/index'],] : null,
                Yii::$app->user->can('view_division') ? ['label' => 'Divisions', 'icon' => 'dot-circle', 'iconStyle' => 'far', 'url' => ['/divisions/index'],] : null,
                Yii::$app->user->can('view_office') ? ['label' => 'Offices', 'icon' => 'dot-circle', 'iconStyle' => 'far', 'url' => ['/office/index'],] : null,
                Yii::$app->user->can('view_division_program_unit') ? ['label' => 'Division/Program/Unit', 'icon' => 'dot-circle', 'iconStyle' => 'far', 'url' => ['/division-program-unit/index'],] : null,
            ...
            $accountingReports = [
                ...
                Yii::$app->user->can('view_ro_trial_balance') ?   ['label' => 'Trial Balance', 'icon' => 'dot-circle', 'iconStyle' => 'far', 'url' => ['/trial-balance/index'],] : null,
                Yii::$app->user->can('view_ro_conso_trial_balance') ?   ['iconStyle' => 'far', 'label' => 'ConsoTrial Balance', 'icon' => 'dot-circle', 'url' => ['/conso-trial-balance/index'],] : null,
                Yii::$app->user->can('view_ro_sub_trial_balance') ?   ['iconStyle' => 'far', 'label' => 'Sub Trial Balance', 'icon' => 'dot-circle', 'url' => ['/sub-trial-balance/index'],] : null,
            ...
            $budgetMasterRecords = [
                Yii::$app->user->can('view_ro_responsibility_center') ? ['label' => 'Responsibility Center', 'iconStyle' => 'far', 'icon' => 'dot-circle', 'url' => ['/responsibility-center/index'],] : null,
                Yii::$app->user->can('view_document_receive') ? ['label' => 'Document Receive', 'iconStyle' => 'far', 'icon' => 'dot-circle', 'url' => ['/document-recieve/index'],] : null,
            ...
            $poUserMenuItems = [
                ...
                [
                    ...
                    'items' => removeNull([
                        ...
                        Yii::$app->user->can('po_asignatory') ?     ['label' => 'PO Asignatory', 'icon' => 'dot-circle', 'iconStyle' => 'far', 'url' => ['/po-assignatory/index'],] : null,
                        Yii::$app->user->can('po_responsibility_center') ?     ['label' => 'PO Responsibility Center', 'icon' => 'dot-circle', 'iconStyle' => 'far', 'url' => ['/po-responsibility-center/index'],] : null,
                        Yii::$app->user->can('view_payee') ? ['label' => 'Payee', 'icon' => 'dot-circle', 'iconStyle' => 'far', 'url' => ['/payee/index'],] : null,
                    ]),
                ],
                [
                    'label' => 'Accounting',
