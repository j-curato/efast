...
<div class="fmi-project-completions-index">
    ...
    <p>
        <?= Yii::$app->user->can('create_fmi_project_completion') ? Html::a('<i class="fa fa-plus"></i> Create', ['create'], ['class' => 'btn btn-success mdModal']) : '' ?>
    </p>
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function ($model) {
                    $updateBtn = Yii::$app->user->can('update_fmi_project_completion') ? Html::a('<i class="fa fa-pencil-alt"></i>', ['update', 'id' => $model->id], ['class' => 'mdModal']) : '';
