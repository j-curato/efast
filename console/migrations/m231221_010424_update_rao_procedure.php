...
/**
 * Class m231221_010424_update_rao_procedure
 */
class m231221_010424_update_rao_procedure extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        $sql = <<<SQL
            ...
            BEGIN
                ...
                SELECT * FROM orsItms
                                        UNION ALL 
                        SELECT * FROM allotmentAdjustments
                )
                SELECT 
                ...
                process_ors.is_cancelled as isCancelledOrs,
    ...
    {
        echo "m231221_010424_update_rao_procedure cannot be reverted.\n";
