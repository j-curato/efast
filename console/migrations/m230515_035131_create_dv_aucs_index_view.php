...
/**
 * Class m230515_035131_create_dv_aucs_index_view
 */
class m230515_035131_create_dv_aucs_index_view extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        YIi::$app->db->createCommand("DROP VIEW IF EXISTS dv_aucs_index;
    ...
    {
        echo "m230515_035131_create_dv_aucs_index_view cannot be reverted.\n";
