...
class m211008_015604_create_cadadr_view extends Migration
{
    ...
    public function safeUp()
    {
        ...
        SELECT
            ...
            0 as nca_recieve,
            IF(cash_disbursement.mode_of_payment LIKE'%check%' ,IFNULL(total_dv.total_amount,0),0) as check_issued,
            IF(cash_disbursement.mode_of_payment LIKE'%ada%' ,IFNULL(total_dv.total_amount,0),0) as ada_issued
            ...
            SELECT
                '' as mode_of_payment,
                cash_adjustment.reporting_period,
                ''dv_number,
                '' as dv_date,
            '' as check_or_ada_no,
                '' as ada_number,
                cash_adjustment.date as issuance_date, 
                '' as account_name,
            particular,
                books.`name` as  book_name,
            0 as  nca_recieve,
            0 as check_issued,
                cash_adjustment.amount as ada_issued
            FROM
            cash_adjustment 
