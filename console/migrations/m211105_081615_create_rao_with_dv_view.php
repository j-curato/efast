...
/**
 * Class m211105_081615_create_rao_with_dv_view
 */
class m211105_081615_create_rao_with_dv_view extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        $sql = <<<SQL
            ...
            dv_aucs.dv_number,
            dv_aucs_entries.amount_disbursed as dv_amount_disburse,
            IF(dv_aucs.is_cancelled=1,'cancelled','not-cancelled') as dv_cancelled,
            IF (cash_disbursement.is_cancelled =1,'cancelled','not-cancelled')as cash_cancelled
    ...
    {
        Yii::$app->db->createCommand('DROP VIEW IF EXISTS rao_with_dv')->query();
    }
    ...
    {
        echo "m211105_081615_create_rao_with_dv_view cannot be reverted.\n";
